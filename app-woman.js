...
App.prototype = {
    ...
    loadModels: function() {
        ...
        /*
        window.box = new THREE.Mesh(new THREE.BoxGeometry(300, 1700, 300), new THREE.MeshBasicMaterial());
        box.position.y = 1700 / 2;
        this.scene.add(box);
        var name = 'led_tv/led_tv';
        var name = 'wall-flat-tv/wall-flat-tv';
        var name = 'livreJava/livreJava';
        var name = 'holdingFemale02/holdingFemale02';
        var name = 'holdingFemale03/holdingFemale03';
        var name = 'sitFemale03/sitFemale03';
        //var name = 'sh3dMag/sh3dMag';
        //var name = 'bd/bd';
        //var name = 'bdOuverte/bdOuverte';
        this.mtlLoader = new THREE.MTLLoader(this.loader);
        this.objLoader = new THREE.OBJLoader(this.loader);
        this.mtlLoader.load(self.assetsPath + 'sweethome/' + name + '.mtl', function(materials) {
            materials.preload();
            self.objLoader.setMaterials(materials);
            self.objLoader.load(self.assetsPath + 'sweethome/' + name + '.obj', function(object) {
                 
                //object.scale.set(12, 12, 12); //livreJava
                object.scale.set(10, 10, 10); //woman
                object.position.z = object.position.x = object.position.y = 0;
                
                
                
                self.shelving.visible = false;
                window.obj = object;
